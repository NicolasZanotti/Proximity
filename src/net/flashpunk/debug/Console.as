package net.flashpunk.debug
{
	...
	public class Console
	{
		...
		public function enable():void
		{
			...
			var b:BitmapData = new (getDefinitionByName("console_logo.png") as Class)(0, 0) as BitmapData;
			FP.matrix.identity();
...
//			_butRead.addChild(_butStep = new CONSOLE_STEP as Bitmap).x = 40;
			...
			_butRead.addChild(_butDebug = new Bitmap(new (getDefinitionByName("console_debug.png") as Class)(0, 0) as BitmapData));
			_butRead.addChild(_butOutput = new Bitmap(new (getDefinitionByName("console_output.png") as Class)(0, 0) as BitmapData));
			_butRead.addChild(_butPlay = new Bitmap(new (getDefinitionByName("console_play.png") as Class)(0, 0) as BitmapData)).x = 20;
			_butRead.addChild(_butPause = new Bitmap(new (getDefinitionByName("console_pause.png") as Class)(0, 0) as BitmapData)).x = 20;
			_butRead.addChild(_butStep = new Bitmap(new (getDefinitionByName("console_step.png") as Class)(0, 0) as BitmapData)).x = 40;
		...
		/** @private */ private var _format:TextFormat = new TextFormat("04b03");
