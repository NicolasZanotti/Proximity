package proximity.entities
{
	 ...
	 */
	public class Box extends Box2DEntity implements GameEntity
	{
		...
		public function Box(name:String, x:Number = 0, y:Number = 0, angle:Number = 0)
		{
			_image = new Image(new (getDefinitionByName("box.png") as Class)(0, 0) as BitmapData);
			_image.centerOrigin();
