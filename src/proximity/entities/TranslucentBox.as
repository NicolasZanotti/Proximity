package proximity.entities
{
	 ...
	 */
	public class TranslucentBox extends Box2DEntity implements GameEntity
	{
		...
		public function TranslucentBox(name:String, x:Number = 0, y:Number = 0, angle:Number = 0)
		{
			_image = new Image(new (getDefinitionByName("translucentbox.png") as Class)(0, 0) as BitmapData);
			_image.centerOrigin();
		...
		public function set isHarmful(isHarmful:Boolean):void
		{
			_harmful = isHarmful;
		}
	}
